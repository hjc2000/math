...
MODEL                   = s5_1
MODULES                 = rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c s5_1.c s5_1_capi.c s5_1_data.c s5_1_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = s5_1.exe
MAKEFILE                = s5_1.mk
MATLAB_ROOT             = D:\Program Files\Polyspace\R2020b
ALT_MATLAB_ROOT         = D:\PROGRA~1\Polyspace\R2020b
MATLAB_BIN              = D:\Program Files\Polyspace\R2020b\bin
ALT_MATLAB_BIN          = D:\PROGRA~1\Polyspace\R2020b\bin
START_DIR               = D:\workspace\MATLAB\hjcmatlab
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 5
BUILDARGS               =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="D:\\Program Files\\Polyspace\\R2020b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = s5_1_ref.rsp
COMPILER_COMMAND_FILE     = s5_1_comp.rsp
