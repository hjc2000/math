...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . abnvgs1q43 ) , 0 , 0 , 19 } ,
{ ( char_T * ) ( & rtDW . dttnef2i21 ) , 0 , 0 , 1 } , { ( char_T * ) ( &
rtDW . c44ymysp45 ) , 14 , 0 , 1 } , { ( char_T * ) ( & rtDW . dr1oipabeo .
LoggedData ) , 11 , 0 , 1 } , { ( char_T * ) ( & rtDW . nvybx3lnen ) , 6 , 0
, 2 } , { ( char_T * ) ( & rtDW . dk5h0xwq0l ) , 10 , 0 , 1 } } ; static
DataTypeTransitionTable rtBTransTable = { 6U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . Ce ) , 0 ,
0 , 22 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
